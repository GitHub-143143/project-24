...
# Header Section
st.markdown("<h1 style='text-align: center;'> 💡Narayana AI Chatbot </h1>", unsafe_allow_html=True)
st.write("💬 Chat with Narayana AI in a  modern interface.")
